...
[OTEL 전체 데이터 흐름 시각화 보기](https://leesangheee.github.io/ecs-observability/docs/otel-flow.htm)
...
| 문서 | 설명 |
|------|------|
| [OTEL 전체 데이터 흐름](https://leesangheee.github.io/ecs-observability/docs/otel-flow.htm) | App → ADOT Sidecar → Backend → Grafana 전체 흐름 시각화 |
